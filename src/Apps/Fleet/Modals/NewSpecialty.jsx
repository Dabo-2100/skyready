...
export default function NewSpecailty() {
    ...
    useEffect(() => { useSpecialties(serverUrl, token).then((res) => { setSpecialties(res) }) }, [])

    const handleSubmit = () => {
        event.preventDefault();
        let obj = {
            specialty_name: new_specialty_name.current.value,
        }
        new_specialty_name.current.value = "";
        axios.post(`${serverUrl}/php/index.php/api/specialties/store`, obj,
            {
                headers: {
    ...
    const handleDelete = (specialty_id) => {
        Swal.fire({
            icon: "question",
            ...
            if (res.isConfirmed) {
                ...
                axios.post(`${serverUrl}/php/index.php/api/specialties/delete`, obj,
                    {
                        headers: {
                            Authorization: `Bearer ${token}`,
                        },
